      ...
      <section className="py-24 md:py-32 px-6 max-w-[1440px] mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
          ...
          <motion.div 
            ...
            className="card-spotlight-emerald flex flex-col justify-between min-h-[400px] md:min-h-[500px] group relative overflow-hidden"
          >
            <div className="relative z-10 max-w-md">
              <div className="w-12 h-12 bg-white/10 rounded-2xl flex items-center justify-center backdrop-blur-md mb-8">
              ...
              <p className="text-white/80 text-lg leading-relaxed">
                Turn action into experience. Earn points, unlock achievements, and climb leaderboards while making a tangible difference.
              </p>
            </div>
          </motion.div>
          ...
          <motion.div 
            ...
            className="card-spotlight-teal flex flex-col justify-between min-h-[400px] md:min-h-[500px] group relative overflow-hidden"
          >
            <div className="relative z-10 max-w-md">
              <div className="w-12 h-12 bg-white/10 rounded-2xl flex items-center justify-center backdrop-blur-md mb-8">
                <svg className="w-6 h-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <p className="text-white/80 text-lg leading-relaxed">
                Watch your footprint shrink. Detailed metrics show exactly how your recycled tech contributes to global sustainability.
              </p>
            </div>
          </motion.div>
